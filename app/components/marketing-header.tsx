        ...
        <div className="flex items-center justify-between h-16">
          ...
          <NavigationMenu className="hidden lg:flex">
            <NavigationMenuList>
                ...
                <NavigationMenuContent>
                  <div className="w-[500px] p-4">
                    <div className="space-y-3">
                      ...
                      <div className="grid gap-3">
                        {[
                          { icon: Store, title: 'Retail', desc: 'Multi-location scheduling and labor tracking' },
                          { icon: Utensils, title: 'Pubs & Restaurants', desc: 'Shift swaps, tips, and break compliance' },
                          { icon: Building2, title: 'Multi-site Operators', desc: 'Centralized control with site autonomy' },
                          { icon: ShoppingBag, title: 'Franchises', desc: 'Brand standards with franchisee flexibility' },
                        ].map((industry) => (
                          <NavigationMenuLink key={industry.title} asChild>
                            <Link
                              href={`/marketing#${industry.title.toLowerCase()}`}
                              className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                            >
                              <div className="flex items-center gap-3">
                                <div className="p-2 rounded-lg bg-primary/10">
              ...
              <NavigationMenuItem>
                <Link href="/marketing#resources" legacyBehavior passHref>
                  <NavigationMenuLink className={cn('group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50')}>
                    Resources
                  </NavigationMenuLink>
                </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link href="/workforce">
              <Button variant="ghost" className="bg-transparent">Dashboard</Button>
            </Link>
            <Link href="/contact">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t bg-background">
          <div className="px-6 py-4 space-y-3">
            <Link href="/marketing#products" className="block py-2 font-medium">
              Product
            </Link>
            <Link href="/marketing#industries" className="block py-2 font-medium">
              Industries
            </Link>
            <Link href="/marketing#pricing" className="block py-2 font-medium">
              Pricing
            </Link>
            <Link href="/marketing#resources" className="block py-2 font-medium">
              Resources
            </Link>
            ...
            <div className="pt-4 space-y-2 border-t">
              <Link href="/workforce" className="block">
                <Button variant="ghost" className="w-full bg-transparent">Dashboard</Button>
              </Link>

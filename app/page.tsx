...
export default function HomePage() {
  ...
  return (
    <MarketingLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed text-pretty">
                Start with scheduling. Add payroll when ready. Enable earned
                wage access for your team. One modular platform for retail,
                hospitality, and multi-site operators.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3">
              ...
              <span className="text-sm font-medium">
                Built for multi-site & franchises
              </span>
            </div>
            <div className="flex items-center justify-center md:justify-start gap-3">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
            ...
            <h2 className="text-4xl font-bold">
              Choose what you need. Add modules anytime.
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[
              ...
              <Card
                key={i}
                className={`relative ${module.popular ? "border-primary shadow-lg" : ""}`}
              >
                {module.popular && (
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <Button
                    className="w-full"
                    variant={module.popular ? "default" : "outline"}
                  >
                    Get started
                  </Button>
                </CardContent>
            ...
            {[
              {
                ...
                description:
                  "Add your locations, departments, and team members. Import from spreadsheets or enter manually.",
                time: "5 minutes",
              },
              {
                step: "2",
                ...
                description:
                  "Build schedules, track time, manage exceptions. Your WFM foundation is live.",
                time: "2 minutes",
              },
              {
                step: "3",
                ...
                description:
                  "Enable additional modules as you grow. Seamless integration with existing data.",
                time: "Anytime",
              },
            ].map((item, i) => (
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <ul className="space-y-3">
                      {industryContent[
                        selectedIndustry as keyof typeof industryContent
                      ].map((feature, i) => (
            ...
            {[
              {
                ...
                desc: "HQ sets default roles, policies, and workflows. Franchisees inherit and can override as needed.",
              },
              {
                icon: Settings,
                title: "Franchisee control",
                desc: "Franchisees manage their own sites, staff, and schedules independently within brand guidelines.",
              },
              {
                icon: Eye,
                title: "Visibility modes",
                desc: "Choose between aggregated KPIs, anonymised data, or full operational visibility for HQ.",
              },
            ].map((item, i) => (
              <Card key={i}>
                <CardContent className="p-6 space-y-4">
      ...
      <section className="py-20 px-6 bg-muted/30" id="pricing">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 space-y-4">
            ...
            <h2 className="text-4xl font-bold">
              Modular pricing that scales with you
            </h2>
            <p className="text-lg text-muted-foreground">
      ...
      {/* Testimonials */}
      <section className="py-20 px-6" id="resources">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 space-y-4">
              ...
              <Card key={i}>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    across 15 locations. The time savings alone paid for itself
                    in the first month."
                  </p>
      ...
      <section className="py-20 px-6 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl opacity-90 leading-relaxed">
            Join 500+ businesses managing smarter with our modular platform.
